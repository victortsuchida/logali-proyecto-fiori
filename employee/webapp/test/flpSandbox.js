		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Employee",
									"targetURL": "#logaligroupemployee-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupemployee-display": {
								"semanticObject": "logaligroupemployee",
								"action": "display",
								"description": "App Employee",
								"title": "App Employee",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.employee",
									"url": sap.ui.require.toUrl("logaligroup/employee")
								}
							}
						}
					}
